...
local Libary = loadstring(game:HttpGet("https://gist.githubusercontent.com/Heitor000119/9e3fe9d16b8b4b59b675775b2dda0ea3/raw/43cd7ed77b44f4efb55337361deb7c6f1090745d/gistfile1.txt"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "Heitor Hub | Brookhaven RP ",
    SubTitle = "by: Heitor DJs_001008",
    LoadText = "Loading Heitor Hub",
...
InfoTab:AddParagraph({ "Collaborations:", "Joao, Davi, Magekko, Sukuna, Star, pietro" })
InfoTab:AddParagraph({ "You are using:", "Heitor Hub Brookhaven " })
